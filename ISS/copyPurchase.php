  ...
  if(isset($_SESSION['ISStoken']) && !empty($_SESSION['ISStoken'])){
    ...
    if ($result->num_rows === 0){
      ...
      if(isset($_GET["id"]) && !empty($_GET["id"]) && is_numeric($_GET["id"])){
        ...
        $input3 = mysqli_real_escape_string($mysqli, $purchaseID);
        $sql4 = "SELECT * FROM `purchase` WHERE `id`=".$input3;
      ...
      ?>
          ...
          <script>
            ...
            window.onload = function (){
              for (let i=0;i<vendorsIDs.length;i++){
                if(vendorsIDs[i] == "<?php echo $row4['vendorID']; ?>"){
                  document.getElementById("vendorNameText").value = vendorNames[i];
                }
              }
            }
          </script>
              ...
              <form action="addPurchase.php" method="post">
                ...
                <div class="w3-row">
                  <div class="w3-row w3-card-2 w3-white">
                    ...
                    <div class="w3-col m3 s12 w3-padding">
                      <p>
                        ...
                        <?php
                          if($row4["ServiceType"] == 1){
                            echo "<script>document.getElementsByName('poType')[0].value = 'Service';</script>";
                          }else{
                            echo "<script>document.getElementsByName('poType')[0].value = 'Purchase';</script>";
                          }
                        ?>
                      </p>
                    </div>
                    <div class="w3-col m3 s12 w3-padding">
                      <p>
                        ...
                        <input class="w3-input w3-border" type="number" name="poNumber" value="<?php echo $row4['poNumber']; ?>" required>
                      </p>
                    </div>
                    <div class="w3-col m3 s12 w3-padding">
                      <p>
                        <label><b>MRN Number</b></label>
                        <input class="w3-input w3-border" type="text" value="<?php echo $row4['mrnNumber']; ?>" name="mrnNumber">
                      </p>
                    </div>
                    <div class="w3-col m3 s12 w3-padding">
                      <p>
                        ...
                        <input id="vendorIDText" class="w3-input w3-border" style="opacity:0;width:0;" type="text" name="vendorID" value="<?php echo $row4['vendorID']; ?>" required>
                      </p>
                      <p>
                  ...
                  <div class="w3-card-2 w3-white w3-margin-top" id="poItemsDiv">
                    <?php
                      if($row4["ServiceType"] == 0){
                        $sql5 = "SELECT items.name,purchaseItems.itemID,purchaseItems.quantity,purchaseItems.price FROM purchaseItems
                                 LEFT JOIN items
                                 ON purchaseItems.itemID = items.id
                                 WHERE purchaseItems.purchaseID = ".$row4["id"];
                        ...
                        $itmesCounter = 0;
                        $itmesRest = "";
                        echo "<h4 class='w3-padding'><i>Item Details</i></h4>";
                        ...
                        while($row5 = $result5->fetch_assoc()){
                          ...
                          <div class="w3-half">
                            <div class="w3-col m6 s12 w3-padding">
                              <p>
                                <label><b>Item</b></label>
                                <input id="itemInputsName<?php echo $itmesCounter; ?>" class="w3-input w3-border" type="text" name="itemName[]" value="<?php echo $row5['name']; ?>" disabled>
                                <input id="itemInputsID<?php echo $itmesCounter; ?>" class="w3-input w3-border" style="opacity:0;width:0;" value="<?php echo $row5['itemID']; ?>" name="itemID[]" required>
                              </p>
                              <p>
                                <a onclick="searchItem(<?php echo $itmesCounter; ?>)" class="w3-btn w3-small" style="background:#128cae;color:#fff;">Search</a>
                              </p>
                            </div>
                            <div class="w3-col m2 s12 w3-padding">
                              <p>
                                <label><b>Quantity</b></label>
                                <input onchange="calc()" onkeyup="calc()" id="qtyInput<?php echo $itmesCounter; ?>" class="w3-input w3-border" type="number" value="<?php echo $row5['quantity']; ?>" name="quantity[]" required>
                              </p>
                            </div>
                            <div class="w3-col m4 s12 w3-padding">
                              <p>
                                <label><b>Price</b></label>
                                <input onkeydown="validateNumber(event)" onkeyup="calc()" id="priceInput<?php echo $itmesCounter; ?>" class="w3-input w3-border" type="text" value="<?php echo $row5['price']; ?>" name="price[]" required>
                              </p>
                            </div>
                          </div>
                          <?php
                          }else{
                            $removeBtnStyle = "display:none;background:#128cae;color:#fff;";
                            if($result5->num_rows == ($itmesCounter + 1)){
                              $removeBtnStyle = "background:#128cae;color:#fff;";
                            }
                            $itmesRest = $itmesRest . "
                            <div id='im".$itmesCounter."' class='w3-half'>
                              <div class='w3-col m6 s12 w3-padding'>
                                <p>
                                  <label><b>Item #".($itmesCounter + 1)."</b></label>
                                  <input id='itemInputsName".$itmesCounter."' class='w3-input w3-border' type='text' name='itemName[]' value='".$row5["name"]."' disabled>
                                  <input id='itemInputsID".$itmesCounter."' class='w3-input w3-border' style='opacity:0;width:0;' name='itemID[]' value='".$row5["itemID"]."' required>
                                </p>
                                <p>
                                  <a onclick='searchItem(".$itmesCounter.")' class='w3-btn w3-small' style='background:#128cae;color:#fff;'>Search</a>
                                  <a onclick='removeItem(".$itmesCounter.")' class='w3-btn w3-small w3-brown removebtns' style='".$removeBtnStyle."'>X</a>
                                </p>
                              </div>
                              <div class='w3-col m2 s12 w3-padding'>
                                <p>
                                  <label><b>Quantity #".($itmesCounter + 1)."</b></label>
                                  <input onchange='calc()' onkeyup='calc()' id='qtyInput".$itmesCounter."' class='w3-input w3-border' type='number' value='".$row5["quantity"]."' name='quantity[]' required>
                                </p>
                              </div>
                              <div class='w3-col m4 s12 w3-padding'>
                                <p>
                                  <label><b>Price #".($itmesCounter + 1)."</b></label>
                                  <input onkeydown='validateNumber(event)' onkeyup='calc()' id='priceInput".$itmesCounter."' class='w3-input w3-border' type='text' value='".$row5["price"]."' name='price[]' required>
                                </p>
                              </div>
                            </div>
                            ";
                          }
                          $itmesCounter = $itmesCounter + 1;
                        }
                        echo "<div id='moreItemsDiv'>".$itmesRest."</div>";
                        echo "<div class='w3-col m12 s12 w3-padding'>";
                        echo "<a class='w3-small' onclick='addMoreItems()' style='text-decoration:underline;color:#0b5266;cursor:pointer;'>+ add more items</a>";
                        echo "</div>";
                        echo "</div>";
                      }else{
                        $sql5 = "SELECT * FROM `purchaseServices` WHERE `purchaseID`=".$row4["id"];
                        if(!$result5 = $mysqli->query($sql5)){
                          $mysqli->close();
                          die("queryFailed");
                        }
                        $servicesCounter = 0;
                        $serviceRest = "";
                        echo "<h4 class='w3-padding'><i>Service Details</i></h4>";
                        echo "<div class='w3-row'>";
                        while($row5 = $result5->fetch_assoc()){
                          ...
                          <div class="w3-half">
                            <div class="w3-col m6 s12 w3-padding">
                              <p>
                                <label><b>Service</b></label>
                                <input class="w3-input w3-border" type="text" name="serviceName[]" value="<?php echo $row5['serviceName']; ?>" maxlength="100" required>
                              </p>
                            </div>
                            <div class="w3-col m4 s12 w3-padding">
                              <p>
                                <label><b>Price</b></label>
                                <input onkeydown="validateNumber(event)" onkeyup="calc()" class="w3-input w3-border" type="text" value="<?php echo $row5['servicePrice']; ?>" name="servicePrice[]" maxlength="50" required>
                              </p>
                            </div>
                          </div>
                          <?php
                            ...
                            $removeBtnStyle = "display:none;background:#128cae;color:#fff;";
                            if($result5->num_rows == ($servicesCounter + 1)){
                              $removeBtnStyle = "background:#128cae;color:#fff;";
                            }
                            $serviceRest = $serviceRest . "
                            <div id='sv".$servicesCounter."' class='w3-half'>
                              <div class='w3-col m6 s12 w3-padding'>
                                <p>
                                  <label><b>Service #".($servicesCounter + 1)."</b></label>
                                  <input id='serviceInputName".$servicesCounter."' class='w3-input w3-border' type='text' value='".$row5['serviceName']."' name='serviceName[]' maxlength='100' required>
                                </p>
                                <p>
                                  <a onclick='removeService(".$servicesCounter.")' class='w3-btn w3-small w3-brown removebtns3' style='".$removeBtnStyle."'>X</a>
                                </p>
                              </div>
                              <div class='w3-col m4 s12 w3-padding'>
                                <p>
                                  <label><b>Price #".($servicesCounter + 1)."</b></label>
                                  <input onkeydown='validateNumber(event)' onkeyup='calc()' id='servicePriceInput".$servicesCounter."' value='".$row5['servicePrice']."' class='w3-input w3-border' type='text' name='servicePrice[]' maxlength='50' required>
                                </p>
                              </div>
                            </div>
                            ";
                        ...
                        echo "<div id='moreSeviceDiv'>".$serviceRest."</div>";
                        echo "<div class='w3-col m12 s12 w3-padding'>";
                        echo "<a class='w3-small' onclick='addMoreServices()' style='text-decoration:underline;color:#0b5266;cursor:pointer;'>+ add more services</a>";
                        echo "</div>";
                        echo "</div>";
                      }
                    ?>
                    ...
                    <div class="w3-row">
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('currency')[0].value = '".$row4["currency"]."';</script>";
                          ?>
                        </p>
                      </div>
                    </div>
                    <div class="w3-row">
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <input id="currentTotalInput" class="w3-input w3-border" type="text" name="currentTotal" value="<?php echo $row4['currentTotal']; ?>">
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          <label><b>VAT</b></label>
                          <input onchange="calc()" onkeyup="calc()" id="vatInput" class="w3-input w3-border" type="text" name="vat" value="<?php echo $row4['vat']; ?>">
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          <label><b>Grand Total</b></label>
                          <input style="font-weight:bold;" id="grandTotalInput" class="w3-input w3-border" type="text" name="grandTotal" value="<?php echo $row4['grandTotal']; ?>">
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="w3-row">
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <input class="w3-input w3-border" type="date" name="quotationDate" value="<?php echo $row4['quotationDate']; ?>">
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          <label><b>Paid Date</b></label>
                          <input class="w3-input w3-border" type="date" name="paidDate" value="<?php echo $row4['paidDate']; ?>">
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="w3-row">
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('buyer')[0].value = '".$row4["buyer"]."';</script>";
                          ?>
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('advanceRequest')[0].value = '".$row4["advanceRequest"]."';</script>";
                          ?>
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('LPO')[0].value = '".$row4["LPO"]."';</script>";
                          ?>
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('invoice')[0].value = '".$row4["invoice"]."';</script>";
                          ?>
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('deliveryNote')[0].value = '".$row4["deliveryNote"]."';</script>";
                          ?>
                        </p>
                      </div>
                      <div class="w3-col m3 s12 w3-padding">
                        <p>
                          ...
                          <?php
                            echo "<script>document.getElementsByName('mrn')[0].value = '".$row4["mrn"]."';</script>";
                          ?>
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="w3-row">
                      <div class="w3-col m4 s12 w3-padding">
                        <p>
                          ...
                          <textarea class="w3-input w3-border" name="forWho" rows="5" cols="80" style="resize:none;"><?php echo $row4['forWho']; ?></textarea>
                        </p>
                      </div>
                      <div class="w3-col m4 s12 w3-padding">
                        <p>
                          <label><b>Notes</b></label><br>
                          <textarea class="w3-input w3-border" name="notes" rows="5" cols="80" style="resize:none;"><?php echo $row4['notes']; ?></textarea>
                        </p>
                      </div>
                      <div class="w3-col m4 s12 w3-padding">
                        <p>
                          <label><b>Link</b></label><br>
                          <input type="text" name="link" class="w3-input w3-border" value="<?php echo $row4['link']; ?>">
                        </p>
                      </div>
                    </div>
                  </div>
